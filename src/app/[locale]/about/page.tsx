...
const timelineData = [
  {
    ...
    description:
      "Оборудование Culligan установлено в Ташкентском аквапарке. Высокотехнологичные решения гарантируют долгий срок службы и высокое качество воды.",
    icon: Droplets,
    color: "cyan",
    projects: [
      {
        name: "Water Park Tashkent",
  ...
  },
  {
    ...
    description:
      "Установки Culligan в Казахстане, Беларуси, Украине. Партнёрство с крупнейшими предприятиями региона.",
    icon: Globe,
    color: "blue",
    projects: [
  ...
  },
  {
    ...
    description:
      "Culligan успешно работает на объектах Администрации Президента РФ, крупнейших промышленных предприятиях.",
    icon: Landmark,
    color: "purple",
    projects: [
      {
      ...
      {
        name: "Напитки из Черноголовки",
        location: "Черноголовка, Россия",
        type: "production",
      },
      {
        name: "Газпром Headquarters",
        location: "Москва, Россия",
        type: "corporate",
      },
  ...
  },
  {
    ...
    description:
      "Открытие станции водоподготовки в Ашхабаде. Контракт на сумму более $200 млн.",
    icon: DollarSign,
    color: "green",
    projects: [
      {
  ...
  },
  {
    ...
    description:
      "Оборудование Culligan на предприятиях пищевой промышленности, водоканалах Беларуси и России.",
    icon: Factory,
    color: "amber",
    projects: [
  ...
  },
  {
    ...
    description:
      "Открытие фильтрационной станции в Петровском. Сотрудничество с государством.",
    icon: Building2,
    color: "red",
    projects: [
      {
        name: "Фильтрационная станция",
        location: "Луганская область, Украина",
        type: "infrastructure",
        capacity: "20 тыс. м³/день",
      },
    ],
  },
  {
    ...
    description:
      "Инвестиционный проект по организации производства оборудования для водоподготовки на территории Беларуси. Фабрика в Заславле.",
    icon: Award,
    color: "cyan",
    projects: [
      {
        name: "Culligan Bel Factory",
        location: "Заславль, Беларусь",
        type: "production",
        investment: "€60M",
      },
      {
        name: "Белорусско-американский форум",
  ...
  },
  {
    ...
    description:
      "Culligan становится официальным партнёром Национального Олимпийского комитета Беларуси.",
    icon: Star,
    color: "yellow",
    projects: [
      {
      ...
      {
        name: "Открытие в Санкт-Петербурге",
  ...
  },
  {
    ...
    description:
      "Белорусско-американский инвестиционный форум в Нью-Йорке. Culligan Eurasia выбирает Беларусь как центр производства.",
    icon: Globe,
    color: "blue",
    projects: [
      { name: "Слоним", location: "Беларусь", type: "infrastructure" },
      {
        name: "Форум в Нью-Йорке",
        location: "Нью-Йорк, США",
        type: "partnership",
      },
      {
        name: "Форум в Лондоне",
  ...
  },
  {
    ...
    description:
      "Строительство завода в Заславле. Culligan Eurasia регистрируется в Минске.",
    icon: Factory,
    color: "purple",
    projects: [
      {
      ...
      {
        name: "Берёзовский сыродельный завод",
        location: "Иваново, Беларусь",
        type: "production",
      },
    ],
  },
  {
    ...
    description:
      "Запуск современных станций обезжелезивания. Сотрудничество с Tetra Pak.",
    icon: Zap,
    color: "cyan",
    projects: [
      {
        name: "Tetra Pak Partnership",
        location: "Международный",
        type: "partnership",
      },
      {
        name: "Кобринский маслосырзавод",
        location: "Кобрин, Беларусь",
        type: "production",
      },
      {
  ...
  },
  {
    ...
    description:
      "Формирование видения помощи обществу и планете. Разработка концепции VODPROM — платформы для реализации совместных решений.",
    icon: Target,
    color: "green",
    projects: [
  ...
  },
  {
    ...
    description:
      "Создание децентрализованной экосистемы мониторинга воды на базе блокчейна. Интеграция IoT, AI и автоматических лабораторий.",
    icon: Droplets,
    color: "cyan",
    projects: [
      { name: "VODeco Platform", location: "Глобальный", type: "platform" },
      {
        name: "VOD-Lab Network",
        location: "Глобальный",
        type: "infrastructure",
      },
...
const galleryImages = [
  {
    src: "/images/gallery/tashkent-park.jpg",
    caption: "Ташкентский аквапарк, 2003",
  },
  { src: "/images/gallery/nemiroff.jpg", caption: "Завод Nemiroff, 2003" },
  { src: "/images/gallery/minsk-arena.jpg", caption: "Минск-Арена, 2016" },
  {
    src: "/images/gallery/culligan-factory.jpg",
    caption: "Завод Culligan Bel, 2015",
  },
  { src: "/images/gallery/ashgabat.jpg", caption: "Станция в Ашхабаде, 2006" },
  {
    src: "/images/gallery/vodeco-platform.jpg",
    caption: "Платформа VODeco, 2024",
  },
];
            ...
            >
              <div className="glass-card p-6 text-center">
                ...
                <p className="text-water-200/60 text-sm">
                  Вода — один из ключевых ресурсов Земли. Мы посвятили жизнь
                  изучению взаимодействия водных ресурсов экосистемы Земли и
              ...
              <div className="glass-card p-6 text-center">
                ...
                <p className="text-water-200/60 text-sm">
                  Создание глобальной децентрализованной экосистемы для
                  мониторинга и управления водными ресурсами на базе блокчейна и
                  IoT.
                </p>
              </div>
              ...
              <div className="glass-card p-6 text-center">
                ...
                <p className="text-water-200/60 text-sm">
                  Прозрачность, устойчивость, инновации и сотрудничество для
                  сохранения водных ресурсов планеты для будущих поколений.
                </p>
              </div>
            </motion.div>
          </div>
          ...
          <div className="max-w-7xl mx-auto">
            ...
            >
              ...
              <p className="text-water-200/70 max-w-2xl mx-auto">
                От первых проектов Culligan в 2003 году до запуска экосистемы
                VODeco
              </p>
            </motion.div>
            ...
            <div className="relative">
              ...
              {timelineData.map((item, index) => (
                ...
                >
                  ...
                  {/* Content */}
                  <div
                    className={`flex-1 ${index % 2 === 0 ? "md:text-right" : "md:text-left"} pl-20 md:pl-0`}
                  >
                    <motion.div
                    ...
                    >
                      ...
                      >
                        <div
                          className={`w-12 h-12 rounded-full bg-gradient-to-br ${colorVariants[item.color].split(" ")[0]} ${colorVariants[item.color].split(" ")[1]} flex items-center justify-center flex-shrink-0`}
                        >
                          <item.icon
                            className={`w-6 h-6 ${colorVariants[item.color].split(" ")[3]}`}
                          />
                        </div>
                        <div>
                      ...
                      {item.projects && item.projects.length > 0 && (
                        ...
                        >
                          ...
                          {item.projects.map((project, pIndex) => (
                            <div
                              key={pIndex}
                              className={`flex items-center gap-2 text-sm text-water-200/60 ${index % 2 === 0 ? "md:flex-row-reverse" : ""}`}
                            >
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
              {partnersData.map((partner, index) => (
                ...
                >
                  ...
                  <p className="text-sm text-water-200/50 mb-2">
                    {partner.location}
                  </p>
                  <div className="text-xs text-cyan-400">
                    {partner.projects} проект(ов)
                  </div>
                </motion.div>
              ))}
            </div>
                ...
                >
                  <div className="flex items-center gap-4">
                    ...
                    <div>
                      ...
                      <p className="text-sm text-water-200/50">
                        {doc.type} • {doc.size}
                      </p>
                    </div>
                  </div>
            ...
            <div className="glass-card p-8">
              <div className="grid md:grid-cols-3 gap-6">
                ...
                <div className="text-center">
                  ...
                  <a
                    href="mailto:partners@vodeco.io"
                    className="text-cyan-400 hover:underline"
                  >
                    partners@vodeco.io
                  </a>
          ...
          <div className="max-w-4xl mx-auto">
            ...
            >
              ...
              <p className="text-water-200/70 mb-8 max-w-2xl mx-auto">
                Станьте частью глобального движения за прозрачность и
                устойчивость водных ресурсов. Инвестируйте в будущее планеты.
              </p>
